...
# 1. Contrôles et relevés d'identité judiciaires

## 1.1. Contrôle de police judiciaire aussi dit "contrôle d'initiative" ou "contrôle individualisé" 
...
### 1.1.1. Contrôle sur réquisitions du procureur de la République
...
### 1.2.1. Contrôle frontalier dit "Schengen"
...
### 1.2.3. Vérification de situation des étrangers 
...
### 1.2.4. Contrôles opérés par certains fonctionnaires
...
## 2.1. Focus interpellation dans un domicile
...
# 5. Retenue pour vérification du droit au séjour d'un étranger
